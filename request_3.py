...
if cou["data"][user1-1]["childExercises"]!=[]:
    ...
    print(data_1["data"][user1-1]["slug"])
...
#         json.dump(Data_1,saral_courses,indent=4)
# i=0
# while i<len(Data_1["availableCourses"]):
#     Courses_name = (Data_1["availableCourzses"][i]["name"])
#     print(i+1,".",Courses_name,",Id.",Data_1["availableCourses"][i]["id"])
#     i+=1

#     # for i in (Data_1["availableCourses"]):
...
# # if os.path.isfile("parent"+selected_Courses_name+str(parent_id)[choose_course-1]["name"]+"json"):
# #     with open("parent"+selected_Courses_name+str(parent_id)[choose_course-1]["name"]+"json","r") as parent_courses:
# #         Data_1=json.load(parent_courses)
